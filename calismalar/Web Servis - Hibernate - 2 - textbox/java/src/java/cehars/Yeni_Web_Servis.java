...
public class Yeni_Web_Servis {
     ...
     * Web service operation
     */
    @WebMethod(operationName = "operasyon3")
    public String operasyon3(@WebParam(name = "perametre1") String perametre1) {
        
        int id = Integer.parseInt(perametre1);
        
        Session sess = NewHibernateUtil.getSessionFactory().openSession();
        Rezervasyon deneme = (Rezervasyon)sess.get(Rezervasyon.class, id);
       // System.out.print(deneme.getIsim());
