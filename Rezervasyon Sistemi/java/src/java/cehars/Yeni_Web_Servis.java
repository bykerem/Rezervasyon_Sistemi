            ...
            Rezervasyon emp = (Rezervasyon) it.next();
             if ( emp.getIsim().equals(otel_ismi) ) {
                 ...
                 if (bos == 0) {
                     ...
                     return otel_ismi+"inde " +bos +" kişilik boş yer var";
                 }
             }
         }
            ...
            Rezervasyon emp = (Rezervasyon) it.next();
             if ( emp.getIsim().equals(otel_ismi) ) {
                 ...
                 if (bos == 0) {
                     ...
                     if (bos2 < 0) {
                         return "en fazla " +bos+" yer ayırabilirsiniz";
                     } else {
            ...
            Rezervasyon emp = (Rezervasyon) it.next();
             if ( emp.getIsim().equals(otel_ismi) ) {
                 ...
                 if (bos <= 0) {
                     ...
                     int toplam = bos2 + kisi2;
                     int bos3 = bos - toplam;
                     
                 
                     if (bos3 < 0) {
                         return otel_ismi+"inde "+kac_kisi+" kişilik boş yer bulunmamaktadır!";
                     } else {
